...
/**
 * Created by 1466811 on 4/6/2016.
 */
public class HttpPost {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HttpHost host = new HttpHost("localhost", 8098);
        ...
        try {
            ...
            HttpEntity[] requestBodies = {
                    ...
                    new ByteArrayEntity("This is the second test request".getBytes(Consts.UTF_8),
